...
class ModelManager: ObservableObject {
    ...
    func getModelPath() -> String? {
        ...
        return getDocumentsDirectory().appendingPathComponent("gemma-3b-4b-it.tflite").path
    }
    ...
    private func modelExists() -> Bool {
        let modelPath = getDocumentsDirectory().appendingPathComponent("gemma-3b-4b-it.tflite").path
